...
export class ActionHistoryAction {
	static readonly loadActionHistory = createAction(`[${ActionHistoryAction.name}] load action history [...]`, props<{projectId: string}>());
	...
	static readonly clearActionHistory = createAction(`[${ActionHistoryAction.name}] clear action history [...]`, props<{projectId: string}>());
